...
export default function Home() {
  ...
  const exportPDF = async () => {
    ...
    doc.setFontSize(14);
    doc.setFont("helvetica", "bold");
    doc.text("Decision Use Case", 20, yPos);

    yPos += 8;
    doc.setFontSize(11);
    doc.setFont("helvetica", "normal");
    const decisionLines = doc.splitTextToSize("This analysis supports early-stage site screening, infrastructure planning, insurance risk review, and prioritization of locations requiring deeper investigation.", 170);
    doc.text(decisionLines, 20, yPos);
    yPos += (decisionLines.length * 6) + 5;
